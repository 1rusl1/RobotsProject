...
//  RobotsProject
//
//  Created by Ruslan Sabirov on 03.01.2020.
...
class WaterfallLayout: UICollectionViewLayout {
    ...
    private let maxItemSpacing: CGFloat = 16
    private let heightOffset: CGFloat = 44
    ...
    private var itemSpacing: CGFloat {
        return isSingleColumn ? 1 : maxItemSpacing
    }
    ...
    override func prepare() {
        ...
        if numberOfItems > 0 {
            ...
            pagingViewAttributes.frame = CGRect(x: 0, y: contentHeight, width: collectionView.frame.width, height: heightOffset)
